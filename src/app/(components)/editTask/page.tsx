...
return(
        ...
        <div>
            {allow?<form onSubmit={handleEdit} className="flex gap-2  rounded-full px-4 py-2">
            <input type="text" value={editTask} onChange={(e)=>seteditTask(e.target.value)} className=" w-20 md:w-44 p-2 rounded-2xl text-sm shadow-md outline-none bg-gray-300"></input>
